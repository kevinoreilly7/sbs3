...
class RequirementsControllerTest < ActionController::TestCase
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post :create, requirement: { location: @requirement.location, monthly_price: @requirement.monthly_price, requirement_name: @requirement.requirement_name, sf_amount: @requirement.sf_amount, sf_price: @requirement.sf_price, user_id: @requirement.user_id }
    end
  ...
  test "should update requirement" do
    put :update, id: @requirement, requirement: { location: @requirement.location, monthly_price: @requirement.monthly_price, requirement_name: @requirement.requirement_name, sf_amount: @requirement.sf_amount, sf_price: @requirement.sf_price, user_id: @requirement.user_id }
    assert_redirected_to requirement_path(assigns(:requirement))
  end
